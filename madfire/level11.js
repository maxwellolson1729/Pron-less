(function () {
  ...
  verify.addEventListener(
    ...
    function () {
      ...
      if (stage === 1) {
        ...
        showError(
          "Humanity not detected. Try again."
        );
      ...
      if (elapsed < 10000) {
        showError(
          "Suspiciously fast. Robots are fast... try again."
        );
      ...
      message.textContent =
        "Verification complete. You may be human.";
  ...
  audio.addEventListener(
    ...
    function () {
      alert(
        "Audio challenge unavailable. Please use the image challenge."
      );
    }
  );
  ...
  info.addEventListener(
    ...
    function () {
      alert(
        "Select every square that matches the instruction, then click VERIFY."
      );
    }
  );
